...
async function getCreateCounter(){
    return createCounter;
}

async function getRetrieveCounter(){
    return retrieveCounter;
}

async function getUpdateCounter(){
    return updateCounter;
}

async function getDeleteCounter(){
...
module.exports = {
    ...
    getCreateCounter: getCreateCounter,
    getRetrieveCounter: getRetrieveCounter,
    getUpdateCounter: getUpdateCounter,
    getDeleteCounter: getDeleteCounter
};